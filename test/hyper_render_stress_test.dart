...
void main() {
  group('HyperRender Stress Tests', () {
    testWidgets('Massive DOM depth does not stack overflow', (WidgetTester tester) async {
    ...
    testWidgets('Renders 10,000 consecutive paragraphs efficiently', (WidgetTester tester) async {
      // Generate 10,000 paragraphs
      final sb = StringBuffer();
      for (var i = 0; i < 10000; i++) {
        sb.write('<p>Paragraph \$i with some text to fill up the layout engine.</p>');
      }
