...
// NOTE: the Performance tab that used to live here was removed during the
// demo consolidation. It measured parse + style timing with a document-size
// selector — a strict subset of the Performance Deep Dive screen's Pipeline
// tab, which measures parse/style/layout/paint over the same size choices.
// Two screens racing to be the perf story helps nobody, and timing never
// belonged on a screen the home page presents as "Dark Mode & Visual
// Quality". Perf lives in Engineering & Quality → Performance Deep Dive.
